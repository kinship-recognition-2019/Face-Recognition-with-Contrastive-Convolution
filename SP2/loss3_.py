...
def main():
    ...
    parser.add_argument('--basemodel',type=str,default="Contrastive_4Layers",help="basemodel (Contrastive_4Layers/seresnet50/resnet50/inception_resnet_v2")
    ...
    parser.add_argument('--start-epoch', default=2, type=int, metavar='N', help='manual epoch number (useful on restarts)')
    ...
    parser.add_argument('--resume', default='model_kinship2_checkpoint.pth.tar', type=str, metavar='PATH',
    ...
    parser.add_argument('--fiw-train-list-path', type=str, default='../dataset/FIW_List/father-daughter/fd_train1.csv',
                        help='path to fiw train list')
    parser.add_argument('--fiw-test-list-path', type=str, default='../dataset/FIW_List/father-daughter/fd_test1.csv',
                        help='path to fiw test list')
    # parser.add_argument('--pairs_list_path',type=str,default="listW/fd_train1.csv",help='pairs list csv')
    ...
    if(args.basemodel == "Contrastive_4Layers"):
        ...
        basemodel = Contrastive_34Layers(num_classes=args.num_classes).to(device)
