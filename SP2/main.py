...
def train(args, basemodel, idreg_model, genmodel, reg_model, reg_model_kinship, device, train_loader, optimizer, criterion, criterion1, iteration,alpha,ratios):
    ...
    for batch_idx, (data_1, data_2, c1, c2, target) in enumerate(train_loader):
        ...
        loss = loss3 + alpha*loss2
        #loss = loss1
        ratios.append(loss3/(loss2+1e-6))
        loss.backward()
...
def main():
    ...
    parser.add_argument('--resume', default='../model/casia/model90000Contrastive_4Layers_checkpoint.pth.tar', type=str, metavar='PATH',
    ...
    parser.add_argument('--pairs_list_path',type=str,default="list/fd_train1.csv",help='pairs list csv')
