...
def Dense_net(input_x,nb_block=2,filters=48,is_training=True,class_num=128,dropout_rate=0.2):
    ...
    x = dense_block(input_x=x, nb_layers=64, layer_name='dense_3',filters=filters,is_training=is_training,dropout_rate=dropout_rate)
    x = transition_layer(x, scope='trans_3',is_training=is_training,dropout_rate=dropout_rate)

    x = dense_block(input_x=x, nb_layers=48, layer_name='dense_final',filters=filters,is_training=is_training,dropout_rate=dropout_rate)
