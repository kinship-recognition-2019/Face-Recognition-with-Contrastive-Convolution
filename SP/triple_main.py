...
def train(args, basemodel, idreg_model, genmodel, reg_model,  device, train_loader, optimizer, criterion, criterion1, iteration):
    ...
    for batch_idx, (data_1, data_2, data_3) in enumerate(train_loader):
        ...
        pos_dist=F.pairwise_distance(feature_vector1,feature_vector2,2)
        ...
        neg_dist = F.pairwise_distance(feature_vector3,feature_vector4,2)
...
def main():
    ...
    for iterno in range(args.start_epoch + 1, args.iters + 1):
        ...
        train_dataset = FIWTrainTripleDataset(img_path=args.fiw_img_path, list_path=args.fiw_train_list_path,noofpairs=args.batch_size, transform=transform)
