...
def train(args, basemodel, idreg_model, genmodel, reg_model, reg_model_kinship, device, train_loader, optimizer, criterion, criterion1, iteration):
    ...
    for batch_idx, (data_1, data_2, c1, c2, target) in enumerate(train_loader):
        ...
        feature_vector2 = org_kernel_2.view(bs,m*n)
...
def main():
    ...
    parser.add_argument('--num_classes', default=1000, type=int,
                        metavar='N', help='number of classes (default: 10574)')
    parser.add_argument('--fiw-train-list-path', type=str, default='/media/zhang/新加卷/pycode/Contrastive-Convolution-new/dataset/FIW_List/sister-sister/ss_train.csv',
                        help='path to fiw train list')
    parser.add_argument('--fiw-test-list-path', type=str, default='/media/zhang/新加卷/pycode/Contrastive-Convolution-new/dataset/FIW_List/sister-sister/ss_test.csv',
