...
def main():
    ...
    parser.add_argument('--basemodel',type=str,default="densenet161",help="basemodel (Contrastive_4Layers/seresnet50/resnet50/inception_resnet_v2/densenet161")
    parser.add_argument('--batch_size', type=int, default=52, metavar='N', help='input batch size for training (default: 64)')
    ...
    elif(args.basemodel == "densenet161"):
        print("densenet161")
        basemodel = densenet161()
